...
// 这个就是 $mount 方法，会在 paltform/runtime 中挂载到 Vue.prototype 上
export function mountComponent (
  ...
  // 设置 vm._watcher = 渲染 watcher，这里创建就会执行 get 也就是 updateComponent，触发渲染
  ...
  // 主实例在这里执行，内部组件的 mounted 都是在 insert hook 里触发的
  if (vm.$vnode == null) {
    vm._isMounted = true
    callHook(vm, 'mounted')
  }
